...
typedef NS_ENUM(unsigned int, MTMathListSubIndexType) {
    ...
    kMTSubIndexTypeBeforeSubscript,
    /* Sub indexes for exponent layouts */
    kMTSubIndexTypeExponent,
    kMTSubIndexTypeExpSuperscript,
    kMTSubIndexTypeExpSubscript,
    kMTSubIndexTypeExpBeforeSubscript,
    /* Sub indexes for exponent layouts */
    ...
    kMTSubIndexTypeOverbar,
    kMTSubIndexTypeLargeOp,
    kMTSubIndexTypeLargeOpValueHolder,
    kMTSubIndexTypeTable,
    kMTSubIndexTypeRow0Col0,
    kMTSubIndexTypeRow0Col1,
    kMTSubIndexTypeRow1Col0,
    kMTSubIndexTypeRow1Col1,
    kMTSubIndexTypeLeftOperand,
    kMTSubIndexTypeRightOperand,
    kMTSubIndexTypeAbsValue,
...
@property (nonatomic)BOOL isIndexAtLayoutEnd;
...
- (MTMathListIndex*_Nullable)levelDownToNextLayout;
- (MTMathListIndex*_Nullable) endIndex;
- (MTMathListIndex*_Nullable)replaceSubIndex:(MTMathListIndex*_Nonnull)interAtomIndex withSubIndexType:(MTMathListSubIndexType)subIndexType isEndAtom:(BOOL)isAtEnd;
- (MTMathListIndex *_Nullable)previousIndex;
- (MTMathListIndex *_Nullable)getParentIndex;
/**
